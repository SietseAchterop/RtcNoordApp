...
# added qmlgetfigure function to get function across from qml to python again
...
class FigureCanvasQtQuickAgg(QtQuick.QQuickPaintedItem, FigureCanvasAgg):
    ...
    def paint(self, p):
        ...
        if self.blitbox is None:
            ...
            #  on ubuntu 22.04 and debian 12 the int's are needed...
    ...
    def mouse_move(self, event):
        ...
        if event.inaxes and event.inaxes.get_navigate():
            ...
            try:
                ...
                # use private mouseover_set for the moment
